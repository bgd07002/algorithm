package InterviewProblems.UW143Spring16.HW2_HTMLValidator;
...
public class HtmlTag {
    ...
    /**
     * Advances to next tag in input; probably not a perfect HTML tag tokenizer, but it will do for this HW
     */
